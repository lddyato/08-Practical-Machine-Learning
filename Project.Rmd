...
cbind( cm1$overall[1], cm2$overall[1], cm3$overall[1])
plot(cm1$table, col = cm1$byClass, main = "Confusion Matrix of Random Forest model (accuracy=0.9943)")
```

From the accuracy of the three prediction models, the first model with random forest approach has the highest accuracy. So i will use the first model to get the predicted result on testing data.
